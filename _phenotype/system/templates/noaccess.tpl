          ...
          <tr>
            <td class="windowFooterGrey2">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr valign="bottom">
                  <td height="120" colspan="2" class="alert">Kein Zugriff!<br>
                  Bitte melden Sie sich mit den erforderlichen Rechten an<br>oder Drücken Sie den Zurück-Button Ihres Browsers.</td>
                </tr>
                <tr bgcolor="#FFFFFF">
