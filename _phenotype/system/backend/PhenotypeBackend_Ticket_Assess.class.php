...
// In der Suche werden eigene Tickets aus nichtzugeordneten Bereichen nicht gefunden, in der �bersicht schon
...
class PhenotypeBackend_Ticket_Assess_Standard extends PhenotypeBackend_Ticket
{
	...
	function renderOverview($sbj_id,$dat_id,$focus,$sortorder,$scope,$action)
	{
		...
		// ToDo Suche auf eigene Aufgabenbereiche einschr�nken
		if ($sbj_id==0)
		{
		...
		if ($action=="search")
		{
			...
			// Dann die Archivsuche, wird nicht angezeigt, wenn generell geschlossene Tickets abgerufen werden k�nnen
