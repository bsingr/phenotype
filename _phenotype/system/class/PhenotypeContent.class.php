...
class PhenotypeContentStandard extends PhenotypeBase
{
	...
	public $showstatus = 1; // Anzeige des Statusflags  0 = nicht, 1 = normal, 2 = ohne Bearbeitungsm�glichkeit
...
?>
	...
	// Diese Funktion ist f�r das Vorberechnen der Skins
	...
	function display($skin = "debug", $count = 0)
	{
		...
		} else // Contentcache ist aktiviert
		{
			...
			if ($tobuild)
			{
				// Cache erzeugen durch externes Contentobjekt, damit evtl. vorher ausgef�hrte
				// Set-Methoden ohne Store nicht die Variablen verf�lschen
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <input name="delete" type="submit" class="buttonWhite" style="width:102px" value="L�schen" onclick="javascript:return confirm('Diesen Datensatz wirklich l&ouml;schen?')"><input name="save" type="submit" class="buttonWhite" style="width:102px"value="Speichern" tabindex="1" accesskey="s">&nbsp;&nbsp;</td>
          </tr>
        </table>
...
?>
		...
		// ######## Selectbox auf Contentdatens�tze
...
?>
		...
		// ######## Multiple Selectbox auf Basis von Contentdatens�tzen
		...
		// ######## Multiple Checkbox auf Basis von Contentdatens�tzen
...
?>
		...
		<tr>
			...
			while ($row = mysql_fetch_array($rs))
			{
				...
				// ND-Erweiterung, Info �ber den Context
...
?>
			 ...
			 function ajax_<?php echo $a[2] ?>_whenCompleted(){
			 	...
			 	{
			 		alert ("AJAX-Fehler, OK f�r Wiederholung ("+ step+")");
			 		ajax_<?php echo $a[2] ?>_doit(step);
			 	}
			 }
...
?>
  	...
  	function <?php echo $token ?>moveup(item)
  	{
  		...
  		if (currentpos>1)
  		{
  			// Item an der �bergeordneten Position bestimmen
