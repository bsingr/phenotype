  ...
  function display($cache=1,$sendHeader=1)
  {
    ...
    if (PT_DEBUG==1)
    {
      ...
      $myPT->startBuffer();
	    ...
	    <li style="display:inline;"><a href="<?php echoADMINURL?>page_edit.php?id=<?php echo$this->id?>" target="_blank"><img src="<?php echo ADMINFULLURL?>img/b_edit.gif" alt="edit page" title="edit page"/></a></li>
