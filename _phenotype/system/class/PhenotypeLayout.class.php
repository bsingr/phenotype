...
<?php
	...
	<tr>
	<td width="300" class="top"><a href="http://www.phenotype-cms.com" target="_blank"><img src="img/phenotype_ani_logo.gif" width="27" height="27" border="0"><img src="img/phenotype_typo.gif" width="97" height="27" border="0"></a></td>
...
<table width="680" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	function workarea_form_text($bez,$name,$val,$x=300,$br=1,$_attributes=Array())
	{
		...
		$html .= '<input type="text" name="'.$name .'" style="width: '.$x.'px" '.$attributes.' value="'.htmlentities(stripcslashes($val),ENT_COMPAT,PT_CHARSET).'">'; //added 08/05/27 by Dominique Bï¿½s
		if ($br==1){$html.="<br>";}
		return $html;
	}
