...
?>		
            ...
            <tr>
              <td class="tableBody"><?=sprintf("%02d",$row["sbj_id"])?></td>
              <td class="tableBody"><span class="tableCellMedia"><a href="admin_subject_edit.php?id=<?=$row["sbj_id"]?>&b=0"><img src="img/t_subject.gif" alt="Aufgabenbereich anzeigen" width="60" height="40" border="0"></a></span></td>
              <td class="tableBody"><?=$row["sbj_bez"]?></td>
              <td align="right" nowrap class="tableBody"><a href="admin_subject_edit.php?id=<?=$row["sbj_id"]?>&b=0"><img src="img/b_edit.gif" alt="Aufgabenbereich anzeigen" width="22" height="22" border="0" align="absmiddle"></a>
<?
	   ...
	   {
?>   
<a href="admin_subject_delete.php?id=<?=$row["sbj_id"]?>" onclick="javascript:return confirm('Diesen Aufgabenbereich wirklich l&ouml;schen?')"> <img src="img/b_delete.gif" alt="Aufgabenbereich l&ouml;schen" width="22" height="22" border="0" align="absmiddle"></a>
<?
       }else
	   {
	   ?>
