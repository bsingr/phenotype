	...
	************************************************************************************************************/	
	...
	function crop_createDivElements()
	{
		...
		smallSquare_tl.src = 'img/crop/small_square.gif';
		...
		smallSquare_tr.src = 'img/crop/small_square.gif';
		...
		smallSquare_bl.src = 'img/crop/small_square.gif';
		...
		smallSquare_br.src = 'img/crop/small_square.gif';
		...
		smallSquare_tc.src = 'img/crop/small_square.gif';
		...
		smallSquare_bc.src = 'img/crop/small_square.gif';
		...
		smallSquare_lc.src = 'img/crop/small_square.gif';
		...
		smallSquare_rc.src = 'img/crop/small_square.gif';
		...
		// ---------------------------------------------
		// start of changes for use within Phenotype CMS
		// ---------------------------------------------
				
		// append div for displaying selection size
		
		cropDiv_selectionsize = document.createElement('DIV');
		cropDiv_selectionsize.style.visibility = 'visible';
		cropDiv_selectionsize.style.position = 'absolute';
		cropDiv_selectionsize.style.left = (crop_imageWidth-100)+'px';
		cropDiv_selectionsize.style.top = (crop_imageHeight+5) + 'px';
		cropDiv_selectionsize.style.height = '15px';
		cropDiv_selectionsize.style.width = '100px';
		//cropDiv_selectionsize.style.border = '1px solid';
		cropDiv_selectionsize.style.textAlign = "right";
		cropDiv_selectionsize.innerHTML = '<span>test</span>';
		crop_imageDiv.appendChild(cropDiv_selectionsize ); 
		
		// -- stop of changes for use within Phenotype CMS
	...
	function resizeTransparentSquares()
	{
		...
		cropDiv_selectionsize.style.left = (cropDiv_right.style.left.replace('px','')/1 -100)+'px';
		cropDiv_selectionsize.style.top = (cropDiv_bottom.style.top.replace('px','')/1 +5)+'px'; 
	...
	function cropScript_updateFormValues()
	{
		...
		// start of changes for use within Phenotype CMS
		// ---------------------------------------------	
		cropDiv_selectionsize.innerHTML = '<span>' + Math.round((cropDiv_dotted.style.width.replace('px','')/1 + (cropToolBorderWidth*2)) * (crop_originalImageWidth/crop_imageWidth)) +'x'+Math.round((cropDiv_dotted.style.height.replace('px','')/1 + (cropToolBorderWidth*2)) * (crop_originalImageHeight/crop_imageHeight))+'</span>';
		// -- stop of changes for use within Phenotype CMS
