...
?>		
            ...
            <tr>
              <td class="tableBody"><?=$row["cog_id"]?></td>
              <td class="tableBody"><span class="tableCellMedia"><a href="toolkit_edit.php?id=<?=$row["cog_id"]?>&b=0"><img src="img/t_bausteingruppe.gif" alt="Baustein anzeigen" width="60" height="40" border="0"></a></span></td>
              <td class="tableBody"><?=$row["cog_bez"]?></td>
              <td align="right" nowrap class="tableBody"><a href="toolkit_edit.php?id=<?=$row["cog_id"]?>&b=0"><img src="img/b_edit.gif" alt="Datensatz bearbeiten" width="22" height="22" border="0" align="absmiddle"></a>
<?
	   ...
	   {
?>   
<a href="toolkit_delete.php?id=<?=$row["cog_id"]?>" onclick="javascript:return confirm('Diese Bausteingruppe wirklich l&ouml;schen?')"> <img src="img/b_delete.gif" alt="Datensatz l&ouml;schen" width="22" height="22" border="0" align="absmiddle"></a>
<?
       }else
	   {
	   ?>
