    ...
    <table width="680" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="windowTab"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td class="windowTitle"><?php echo $id ?> Contentobjekt / <?php echo $row["con_bez"] ?></td>
	...
	<?php
	 ...
	 switch ($_REQUEST["b"])
	 {
	   case 0: 
		 ...
		 $myPT->startBuffer();
		 ?>
					 <input name="anlegen" type="checkbox" value="1" <?php if ($row["con_anlegen"]==1){echo "checked";} ?>> Anlegen<br>
                     <input name="bearbeiten" type="checkbox" value="1" <?php if ($row["con_bearbeiten"]==1){echo "checked";} ?>> Bearbeiten<br>
                     <input name="loeschen" type="checkbox" value="1" <?php if ($row["con_loeschen"]==1){echo "checked";} ?>> L&ouml;schen<br>
	...
	?>
	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td align="right" class="windowFooterWhite"><?php if ($row["C"]==0){ ?><input name="delete" type="submit" class="buttonWhite" style="width:102px" value="Löschen" onclick="javascript:return confirm('Dieses Contentobjekt wirklich l&ouml;schen?')">&nbsp;&nbsp;<?php } ?><input name="save" type="submit" class="buttonWhite" style="width:102px"value="Speichern">&nbsp;&nbsp;</td>
          </tr>
        </table>
	 <?php
