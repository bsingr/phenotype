...
?>		
            ...
            <tr>
              ...
              <td class="tableBody"><span class="tableCellMedia"><a href="admin_mediagroup_edit.php?id=<?=$row["grp_id"]?>&b=0"><img src="img/t_pagegroup.gif" alt="Seitengruppe anzeigen" width="60" height="40" border="0"></a></span></td>
              <td class="tableBody"><?=$row["grp_bez"]?></td>
              <td align="right" nowrap class="tableBody"><a href="admin_mediagroup_edit.php?id=<?=$row["grp_id"]?>&b=0"><img src="img/b_edit.gif" alt="Datensatz bearbeiten" width="22" height="22" border="0" align="absmiddle"></a>
<?
	   ...
	   {
?>   
<a href="admin_mediagroup_delete.php?id=<?=$row["grp_id"]?>" onclick="javascript:return confirm('Diese Mediagruppe wirklich l&ouml;schen?')"> <img src="img/b_delete.gif" alt="Datensatz l&ouml;schen" width="22" height="22" border="0" align="absmiddle"></a>
<?
       }else
	   {
	   ?>
